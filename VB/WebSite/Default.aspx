...
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v9.2" Namespace="DevExpress.Web.ASPxScheduler"
	TagPrefix="dxwschs" %>
<%@ Register Assembly="DevExpress.XtraScheduler.v9.2.Core, Version=9.2.0.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
...
<body>
	...
	<div>
		...
		<dxpc:ASPxPopupControl ID="ASPxPopupControl1" runat="server" ClientInstanceName="confirmAppointmentDragDialog" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" HeaderText="Confirmation dialog">
		<ContentCollection>
